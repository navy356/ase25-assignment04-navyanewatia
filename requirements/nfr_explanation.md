...
- This implementation assumes that core functionalily of the app itself is not changed when adding new meal types or dietary rules. Eg: A Vegan tag 

<!--stackedit_data:
eyJoaXN0b3J5IjpbNTkyNzIxODMzXX0=
-->